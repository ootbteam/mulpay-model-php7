...
/**
 * WalletGetCustomerDataRequest Class Doc Comment
 *
 * @category Class
 * @description /wallet/getCustomerData request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletGetCustomerDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'walletGetCustomerDataRequest';
    ...
    protected static $openAPITypes = [
        'access_id' => 'string',
        'amazon_pay' => '\OotbTeam\MulPay\Model\CustomerDataAmazonPay',
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling WalletGetCustomerDataRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     * Gets amazon_pay
     *
     * @return \OotbTeam\MulPay\Model\CustomerDataAmazonPay|null
     */
     ...
     * Sets amazon_pay
     *
     * @param \OotbTeam\MulPay\Model\CustomerDataAmazonPay|null $amazon_pay Amazon Pay V2専用パラメーター
     *
     * @return self
     */
