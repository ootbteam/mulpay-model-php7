...
/**
 * WalletOnfileChargeRequest Class Doc Comment
 *
 * @category Class
 * @description Pay払い 随時支払い(/wallet/on-file/charge)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletOnfileChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletOnfileChargeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'wallet_onfile_information' => '\OotbTeam\MulPay\Model\WalletOnfileInformation',
    ...
    protected static array $openAPINullables = [
        ...
        'order' => false,
        'payer' => false,
        'wallet_onfile_information' => false,
    ...
    protected static $attributeMap = [
        ...
        'order' => 'order',
        'payer' => 'payer',
        'wallet_onfile_information' => 'walletOnfileInformation',
    ...
    protected static $setters = [
        ...
        'order' => 'setOrder',
        'payer' => 'setPayer',
        'wallet_onfile_information' => 'setWalletOnfileInformation',
    ...
    protected static $getters = [
        ...
        'order' => 'getOrder',
        'payer' => 'getPayer',
        'wallet_onfile_information' => 'getWalletOnfileInformation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wallet_onfile_information', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_onfile_information'] === null) {
            $invalidProperties[] = "'wallet_onfile_information' can't be null";
        }
    ...
    /**
     * Gets wallet_onfile_information
     *
     * @return \OotbTeam\MulPay\Model\WalletOnfileInformation
     */
    public function getWalletOnfileInformation()
    {
        return $this->container['wallet_onfile_information'];
    }

    /**
     * Sets wallet_onfile_information
     *
     * @param \OotbTeam\MulPay\Model\WalletOnfileInformation $wallet_onfile_information wallet_onfile_information
     *
     * @return self
     */
    public function setWalletOnfileInformation($wallet_onfile_information)
    {
        if (is_null($wallet_onfile_information)) {
            throw new \InvalidArgumentException('non-nullable wallet_onfile_information cannot be null');
        }
        $this->container['wallet_onfile_information'] = $wallet_onfile_information;
