    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling OrderReference., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
    ...
    public function setAccessPass($access_pass)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_pass)))) {
            throw new \InvalidArgumentException("invalid value for \$access_pass when calling OrderReference., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
