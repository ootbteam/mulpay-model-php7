...
/**
 * WalletOnfileChargeResponse Class Doc Comment
 *
 * @category Class
 * @description Pay払い 随時支払い(/wallet/on-file/charge)のレスポンスパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletOnfileChargeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletOnfileChargeResponse';
