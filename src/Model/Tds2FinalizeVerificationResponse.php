...
/**
 * Tds2FinalizeVerificationResponse Class Doc Comment
 *
 * @category Class
 * @description クレカ払い 3Dセキュア後有効性確認(/tds2/finalizeVerification)のレスポンスパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Tds2FinalizeVerificationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tds2FinalizeVerificationResponse';
    ...
    protected static $openAPITypes = [
        ...
        'onfile_card_result' => '\OotbTeam\MulPay\Model\OnfileCardResult',
    ...
    protected static $attributeMap = [
        ...
        'onfile_card_result' => 'onfileCardResult',
    ...
    protected static $setters = [
        ...
        'onfile_card_result' => 'setOnfileCardResult',
    ...
    protected static $getters = [
        ...
        'onfile_card_result' => 'getOnfileCardResult',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('onfile_card_result', $data ?? [], null);
    ...
    */
     ...
     * Sets next_action
     *
     * @param \OotbTeam\MulPay\Model\NextAction|null $next_action レスポンスを受け取った後の加盟店様側の処理   有効性確認成功時は`NO_ACTION`です。 - `NO_ACTION`：後続処理なし
     *
     * @return self
     */
     ...
     *
     * @param \OotbTeam\MulPay\Model\OrderReferenceCredit|null $order_reference 有効性確認リクエストの取引情報     - `amount`フィールドは返しません。   - `status`フィールドは必ず`CHECK`です。     - `chargeType`フィールドは必ず`CREDIT`です。
     *
     * @return self
     */
     ...
     * Sets credit_result
     *
     * @param \OotbTeam\MulPay\Model\CreditResult|null $credit_result クレカ払いの結果情報   3Dセキュア後有効性確認では、3Dセキュア認証の利用有無`useTds2`は必ず`true`です。
     *
     * @return self
     */
    ...
    /**
     * Gets onfile_card_result
     *
     * @return \OotbTeam\MulPay\Model\OnfileCardResult|null
     */
    public function getOnfileCardResult()
    {
        return $this->container['onfile_card_result'];
    }

    /**
     * Sets onfile_card_result
     *
     * @param \OotbTeam\MulPay\Model\OnfileCardResult|null $onfile_card_result onfile_card_result
     *
     * @return self
     */
    public function setOnfileCardResult($onfile_card_result)
    {
        if (is_null($onfile_card_result)) {
            throw new \InvalidArgumentException('non-nullable onfile_card_result cannot be null');
        }
        $this->container['onfile_card_result'] = $onfile_card_result;
