...
/**
 * OrderCancelResponseWallet Class Doc Comment
 *
 * @category Class
 * @description /order/cancel response body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderCancelResponseWallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCancelResponseWallet';
