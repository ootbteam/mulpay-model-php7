...
/**
 * WalletChargeRequest Class Doc Comment
 *
 * @category Class
 * @description Pay払い 都度支払い(/wallet/charge)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletChargeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'wallet_information' => '\OotbTeam\MulPay\Model\WalletInformation',
    ...
    protected static $setters = [
        ...
        'order' => 'setOrder',
        'payer' => 'setPayer',
        'wallet_information' => 'setWalletInformation',
    ...
    protected static $getters = [
        ...
        'order' => 'getOrder',
        'payer' => 'getPayer',
        'wallet_information' => 'getWalletInformation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wallet_information', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_information'] === null) {
            $invalidProperties[] = "'wallet_information' can't be null";
        }
    ...
    /**
     * Gets wallet_information
     *
     * @return \OotbTeam\MulPay\Model\WalletInformation
     */
    public function getWalletInformation()
    {
        return $this->container['wallet_information'];
    }

    /**
     * Sets wallet_information
     *
     * @param \OotbTeam\MulPay\Model\WalletInformation $wallet_information wallet_information
     *
     * @return self
     */
    public function setWalletInformation($wallet_information)
    {
        if (is_null($wallet_information)) {
            throw new \InvalidArgumentException('non-nullable wallet_information cannot be null');
        }
        $this->container['wallet_information'] = $wallet_information;
