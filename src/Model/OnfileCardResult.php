...
/**
 * OnfileCardResult Class Doc Comment
 *
 * @category Class
 * @description カードの登録結果
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OnfileCardResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnfileCardResult';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling OnfileCardResult., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
    ...
    public function setMemberName($member_name)
    {
        ...
        if ((mb_strlen($member_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $member_name when calling OnfileCardResult., must be smaller than or equal to 255.');
        }
    ...
    public function setCardId($card_id)
    {
        ...
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($card_id)))) {
            throw new \InvalidArgumentException("invalid value for \$card_id when calling OnfileCardResult., must conform to the pattern /^[0-9]{1,4}$/.");
        }
