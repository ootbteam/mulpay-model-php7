...
/**
 * WalletFrontendWebhook Class Doc Comment
 *
 * @category Class
 * @description 都度支払い（フロントエンド方式）決済結果通知リクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletFrontendWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletFrontendWebhook';
    ...
    public const EVENT_WALLET_PAID = 'WALLET_PAID';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling WalletFrontendWebhook., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     * Sets event
     *
     * @param string $event Webhookイベントタイプ   - `WALLET_PAID`：Pay払い支払い完了
     *
     * @return self
     */
