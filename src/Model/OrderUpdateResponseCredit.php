...
/**
 * OrderUpdateResponseCredit Class Doc Comment
 *
 * @category Class
 * @description /order/update response body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderUpdateResponseCredit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderUpdateResponseCredit';
    ...
    */
     ...
     *
     * @param \OotbTeam\MulPay\Model\OrderReferenceCredit|null $order_reference 取引参照情報
     *
     * @return self
     */
     ...
     * Sets credit_result
     *
     * @param \OotbTeam\MulPay\Model\CreditResult|null $credit_result カード支払い結果情報   金額変更時は元の取引が3Dセキュア認証済であっても、3Dセキュア認証の利用有無`useTds2`は必ず`false`です。
     *
     * @return self
     */
