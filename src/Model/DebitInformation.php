...
/**
 * DebitInformation Class Doc Comment
 *
 * @category Class
 * @description デビットカード情報
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DebitInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DebitInformation';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type カードの種類 - `DEBIT`：デビットカード - `PREPAID`：プリペイドカード - `OTHER`：その他
     *
     * @return self
     */
     ...
     * Sets issuer_name
     *
     * @param string|null $issuer_name カードの発行会社名   `cardType`が `DEBIT`、`PREPAID`の場合のみ返却します。
     *
     * @return self
     */
