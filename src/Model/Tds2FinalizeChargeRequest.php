...
/**
 * Tds2FinalizeChargeRequest Class Doc Comment
 *
 * @category Class
 * @description クレカ払い 3Dセキュア後支払い(/tds2/finalizeCharge)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Tds2FinalizeChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tds2FinalizeChargeRequest';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling Tds2FinalizeChargeRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
