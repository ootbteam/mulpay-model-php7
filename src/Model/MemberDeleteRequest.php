...
/**
 * MemberDeleteRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MemberDeleteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberDeleteRequest';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling MemberDeleteRequest., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
