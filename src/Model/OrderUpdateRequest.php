...
class OrderUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderUpdateRequest';
    ...
    protected static $openAPITypes = [
        'access_id' => 'string',
        'amount' => 'string',
        'authorization_mode' => '\OotbTeam\MulPay\Model\AuthorizationMode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('authorization_mode', $data ?? [], null);
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling OrderUpdateRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     *
     * @return \OotbTeam\MulPay\Model\AuthorizationMode|null
     */
     ...
     *
     * @param \OotbTeam\MulPay\Model\AuthorizationMode|null $authorization_mode 支払い要求のタイプ   クレカ払いの場合は必ず設定してください。   クレカ払い以外は設定しても無視されます。   - `AUTH`：仮売上 - `CAPTURE`：即時売上
     *
     * @return self
     */
