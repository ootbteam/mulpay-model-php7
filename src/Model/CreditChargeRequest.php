 ...
 *
 * @category Class
 * @description クレカ払い 都度支払い(/credit/charge)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'credit_information' => '\OotbTeam\MulPay\Model\CreditInformation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('credit_information', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['credit_information'] === null) {
            $invalidProperties[] = "'credit_information' can't be null";
        }
     ...
     *
     * @return \OotbTeam\MulPay\Model\CreditInformation
     */
     ...
     *
     * @param \OotbTeam\MulPay\Model\CreditInformation $credit_information クレカ払い情報
     *
     * @return self
     */
    public function setCreditInformation($credit_information)
    {
        if (is_null($credit_information)) {
            throw new \InvalidArgumentException('non-nullable credit_information cannot be null');
        }
