...
/**
 * OrderCaptureResponseCredit Class Doc Comment
 *
 * @category Class
 * @description /order/capture response body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderCaptureResponseCredit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCaptureResponseCredit';
