...
/**
 * OnfileCardWithoutCardholderName Class Doc Comment
 *
 * @category Class
 ...
 */
class OnfileCardWithoutCardholderName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnfileCardWithoutCardholderName';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling OnfileCardWithoutCardholderName., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
     ...
     * Sets type
     *
     * @param \OotbTeam\MulPay\Model\OnfileCardType $type 登録されているカードのタイプ   - `CREDIT_CARD`：クレジットカード - `APPLE_PAY`：Apple Pay
     *
     * @return self
     */
    ...
    public function setCardId($card_id)
    {
        ...
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($card_id)))) {
            throw new \InvalidArgumentException("invalid value for \$card_id when calling OnfileCardWithoutCardholderName., must conform to the pattern /^[0-9]{1,4}$/.");
        }
    ...
    public function setIndex($index)
    {
        ...
        if ((!preg_match("/^[0-4]$/", ObjectSerializer::toString($index)))) {
            throw new \InvalidArgumentException("invalid value for \$index when calling OnfileCardWithoutCardholderName., must conform to the pattern /^[0-4]$/.");
        }
