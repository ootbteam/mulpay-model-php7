...
/**
 * Tds2FinalizeVerificationRequest Class Doc Comment
 *
 * @category Class
 * @description クレカ払い 3Dセキュア後有効性確認(/tds2/finalizeVerification)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Tds2FinalizeVerificationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tds2FinalizeVerificationRequest';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling Tds2FinalizeVerificationRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
