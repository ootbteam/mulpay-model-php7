...
/**
 * Tds2FinalizeChargeResponse Class Doc Comment
 *
 * @category Class
 * @description クレカ払い 3Dセキュア後支払い(/tds2/finalizeCharge)のレスポンスパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class Tds2FinalizeChargeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tds2FinalizeChargeResponse';
    ...
    */
     ...
     *
     * @param \OotbTeam\MulPay\Model\OrderReferenceCredit|null $order_reference 支払いリクエストの取引情報     - `status`フィールド以下の値を返します。     - 仮売上成功時: `AUTH`     - 即時売上成功時: `CAPTURE`   - `chargeType`フィールドは必ず`CREDIT`です。
     *
     * @return self
     */
     ...
     * Sets credit_result
     *
     * @param \OotbTeam\MulPay\Model\CreditResult|null $credit_result クレカ払いの結果情報   3Dセキュア後支払いでは、3Dセキュア認証の利用有無`useTds2`は必ず`true`です。
     *
     * @return self
     */
