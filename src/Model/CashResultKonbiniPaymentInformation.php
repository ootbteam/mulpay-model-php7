<?php
/**
 * CashResultKonbiniPaymentInformation
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CashResultKonbiniPaymentInformation Class Doc Comment
 *
 * @category Class
 * @description コンビニ支払い情報
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashResultKonbiniPaymentInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashResult_konbiniPaymentInformation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('voucher_url', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $confirmation_number 確認番号
     *
     * @return self
     */
     ...
     * Sets receipt_number
     *
     * @param string|null $receipt_number 受付番号
     *
     * @return self
     */
     ...
     * Sets voucher_url
     *
     * @param string|null $voucher_url 払込票URL(一部のコンビニのみ)
     *
     * @return self
     */
    public function setVoucherUrl($voucher_url)
    {
        if (is_null($voucher_url)) {
            throw new \InvalidArgumentException('non-nullable voucher_url cannot be null');
        }
