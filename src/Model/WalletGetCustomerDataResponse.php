...
/**
 * WalletGetCustomerDataResponse Class Doc Comment
 *
 * @category Class
 * @description /wallet/getCustomerData response body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WalletGetCustomerDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletGetCustomerDataResponse';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'remarks' => 'string',
        'shipping_information' => '\OotbTeam\MulPay\Model\CustomerShippingAddress',
        'billing_information' => '\OotbTeam\MulPay\Model\CustomerBillingAddress'
    ];
    ...
    */
     ...
     * Sets buyer_id
     *
     * @param string|null $buyer_id 購入者のID
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email 購入者のメールアドレス
     *
     * @return self
     */
     ...
     * Sets remarks
     *
     * @param string|null $remarks 備考   Amazon Pay V2ではお支払い情報が設定されます。
     *
     * @return self
     */
     ...
     *
     * @return \OotbTeam\MulPay\Model\CustomerShippingAddress|null
     */
     ...
     *
     * @param \OotbTeam\MulPay\Model\CustomerShippingAddress|null $shipping_information 配送先情報
     *
     * @return self
     */
     ...
     *
     * @return \OotbTeam\MulPay\Model\CustomerBillingAddress|null
     */
     ...
     *
     * @param \OotbTeam\MulPay\Model\CustomerBillingAddress|null $billing_information 請求先情報
     *
     * @return self
     */
