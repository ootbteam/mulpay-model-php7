...
/**
 * VerificationInquiryRequest Class Doc Comment
 *
 * @category Class
 * @description /verification/inquiry request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class VerificationInquiryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationInquiryRequest';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling VerificationInquiryRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
    ...
    public function setVerificationId($verification_id)
    {
        ...
        if ((mb_strlen($verification_id) > 27)) {
            throw new \InvalidArgumentException('invalid length for $verification_id when calling VerificationInquiryRequest., must be smaller than or equal to 27.');
        }
        if ((!preg_match("/^[-0-9a-zA-Z\\-]+$/", ObjectSerializer::toString($verification_id)))) {
            throw new \InvalidArgumentException("invalid value for \$verification_id when calling VerificationInquiryRequest., must conform to the pattern /^[-0-9a-zA-Z\\-]+$/.");
        }
