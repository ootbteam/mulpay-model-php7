...
/**
 * OrderReferenceCash Class Doc Comment
 *
 * @category Class
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 ...
 */
class OrderReferenceCash implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReferenceCash';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OotbTeam\MulPay\Model\StatusCash',
        'charge_type' => 'string'
    ];
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling OrderReferenceCash., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
    ...
    public function setAccessPass($access_pass)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_pass)))) {
            throw new \InvalidArgumentException("invalid value for \$access_pass when calling OrderReferenceCash., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     * Gets status
     *
     * @return \OotbTeam\MulPay\Model\StatusCash|null
     */
     ...
     * Sets status
     *
     * @param \OotbTeam\MulPay\Model\StatusCash|null $status status
     *
     * @return self
     */
     ...
     * Sets charge_type
     *
     * @param string|null $charge_type 支払いタイプ   - `CASH`: 現金払い
     *
     * @return self
     */
