...
/**
 * CashChargeRequest Class Doc Comment
 *
 * @category Class
 * @description 現金払い(/cash/charge)のリクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CashChargeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashChargeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'cash_information' => '\OotbTeam\MulPay\Model\CashInformation',
    ...
    protected static $setters = [
        ...
        'order' => 'setOrder',
        'payer' => 'setPayer',
        'cash_information' => 'setCashInformation',
    ...
    protected static $getters = [
        ...
        'order' => 'getOrder',
        'payer' => 'getPayer',
        'cash_information' => 'getCashInformation',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cash_information', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cash_information'] === null) {
            $invalidProperties[] = "'cash_information' can't be null";
        }
    ...
    /**
     * Gets cash_information
     *
     * @return \OotbTeam\MulPay\Model\CashInformation
     */
    public function getCashInformation()
    {
        return $this->container['cash_information'];
    }

    /**
     * Sets cash_information
     *
     * @param \OotbTeam\MulPay\Model\CashInformation $cash_information cash_information
     *
     * @return self
     */
    public function setCashInformation($cash_information)
    {
        if (is_null($cash_information)) {
            throw new \InvalidArgumentException('non-nullable cash_information cannot be null');
        }
        $this->container['cash_information'] = $cash_information;
