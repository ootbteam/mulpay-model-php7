...
/**
 * CustomerDataAmazonPay Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerDataAmazonPay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerDataAmazonPay';
    ...
    */
     ...
     *
     * @param string|null $checkout_session_id チェックアウトセッションID
     *
     * @return self
     */
    public function setCheckoutSessionId($checkout_session_id)
    {
        ...
        if ((mb_strlen($checkout_session_id) > 256)) {
            throw new \InvalidArgumentException('invalid length for $checkout_session_id when calling CustomerDataAmazonPay., must be smaller than or equal to 256.');
        }
