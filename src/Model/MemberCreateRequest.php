 ...
 *
 * @category Class
 * @description /member/create request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling MemberCreateRequest., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
    ...
    public function setMemberName($member_name)
    {
        ...
        if ((mb_strlen($member_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $member_name when calling MemberCreateRequest., must be smaller than or equal to 255.');
        }
