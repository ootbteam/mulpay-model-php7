 ...
 */
class SmsPinData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsPinData';
    ...
    public const PIN_TYPE__4 = 'digits-4';
    public const PIN_TYPE__6 = 'digits-6';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pin_type', $data ?? [], 'digits-6');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sms_phone_number']) && (mb_strlen($this->container['sms_phone_number']) > 13)) {
            $invalidProperties[] = "invalid value for 'sms_phone_number', the character length must be smaller than or equal to 13.";
        }
     ...
     *
     * @param string|null $sms_phone_number 携帯電話番号   `verificationInformation.type`が`sms-pin`の場合は必須です。   090、080、070から始まる日本の携帯電話番号を指定してください。   海外電話番号へのSMS配信は行えません。
     *
     * @return self
     */
    public function setSmsPhoneNumber($sms_phone_number)
    {
        ...
        if ((mb_strlen($sms_phone_number) > 13)) {
            throw new \InvalidArgumentException('invalid length for $sms_phone_number when calling SmsPinData., must be smaller than or equal to 13.');
        }
     ...
     * Sets pin_type
     *
     * @param string|null $pin_type 認証コード桁数 未指定の場合は6桁です。 - `digits-4`：4桁 - `digits-6`：6桁
     *
     * @return self
     */
