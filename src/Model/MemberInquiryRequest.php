...
/**
 * MemberInquiryRequest Class Doc Comment
 *
 * @category Class
 * @description /member/inquiry request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MemberInquiryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberInquiryRequest';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling MemberInquiryRequest., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
     ...
     * Gets onfile_type
     *
     * @return \OotbTeam\MulPay\Model\OnfileType|null
     */
     ...
     * Sets onfile_type
     *
     * @param \OotbTeam\MulPay\Model\OnfileType|null $onfile_type 照会したい登録認証情報のタイプ   設定なしの場合は全てのタイプを返します。
     *
     * @return self
     */
