...
/**
 * OrderInquiryRequest Class Doc Comment
 *
 * @category Class
 * @description /order/inquiry request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderInquiryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderInquiryRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['order_id']) && (mb_strlen($this->container['order_id']) > 27)) {
            $invalidProperties[] = "invalid value for 'order_id', the character length must be smaller than or equal to 27.";
        }

        if (!is_null($this->container['order_id']) && !preg_match("/^[-0-9a-zA-Z\\-]+$/", $this->container['order_id'])) {
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling OrderInquiryRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 27)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling OrderInquiryRequest., must be smaller than or equal to 27.');
        }
        if ((!preg_match("/^[-0-9a-zA-Z\\-]+$/", ObjectSerializer::toString($order_id)))) {
            throw new \InvalidArgumentException("invalid value for \$order_id when calling OrderInquiryRequest., must conform to the pattern /^[-0-9a-zA-Z\\-]+$/.");
        }
