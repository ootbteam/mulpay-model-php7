...
/**
 * MemberDeleteItemRequestCard Class Doc Comment
 *
 * @category Class
 * @description /member/delete request body
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MemberDeleteItemRequestCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemberDeleteItemRequestCard';
    ...
    */
    ...
    public function setMemberId($member_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-@_ . ]{1,60}$/", ObjectSerializer::toString($member_id)))) {
            throw new \InvalidArgumentException("invalid value for \$member_id when calling MemberDeleteItemRequestCard., must conform to the pattern /^[a-zA-Z0-9-@_ . ]{1,60}$/.");
        }
     ...
     * Sets onfile_type
     *
     * @param \OotbTeam\MulPay\Model\OnfileType $onfile_type 認証情報タイプ   削除する認証情報タイプとしてクレジットカード`CARD`を設定してください。
     *
     * @return self
     */
    ...
    public function setCardId($card_id)
    {
        ...
        if ((!preg_match("/^[0-9]{1,4}$/", ObjectSerializer::toString($card_id)))) {
            throw new \InvalidArgumentException("invalid value for \$card_id when calling MemberDeleteItemRequestCard., must conform to the pattern /^[0-9]{1,4}$/.");
        }
