...
/**
 * OnfileAmazonPay Class Doc Comment
 *
 * @category Class
 ...
 */
class OnfileAmazonPay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnfileAmazonPay';
    ...
    */
    ...
    public function setNoteToBuyer($note_to_buyer)
    {
        ...
        if ((mb_strlen($note_to_buyer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $note_to_buyer when calling OnfileAmazonPay., must be smaller than or equal to 255.');
        }
