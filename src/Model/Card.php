...
class Card implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]{12,16}$/", $this->container['card_number'])) {
            $invalidProperties[] = "invalid value for 'card_number', must be conform to the pattern /^[0-9]{12,16}$/.";
        }

        if (!is_null($this->container['cardholder_name']) && !preg_match("/^[a-zA-Z0-9- ]{1,50}$/", $this->container['cardholder_name'])) {
            $invalidProperties[] = "invalid value for 'cardholder_name', must be conform to the pattern /^[a-zA-Z0-9- ]{1,50}$/.";
        }
     ...
     * Sets card_number
     *
     * @param string $card_number カード番号<br>ハイフンは含めないでください。
     *
     * @return self
     */
    public function setCardNumber($card_number)
    {
        ...
        if ((!preg_match("/^[0-9]{12,16}$/", ObjectSerializer::toString($card_number)))) {
            throw new \InvalidArgumentException("invalid value for \$card_number when calling Card., must conform to the pattern /^[0-9]{12,16}$/.");
        }
     ...
     *
     * @param string|null $cardholder_name カード名義人
     *
     * @return self
     */
    public function setCardholderName($cardholder_name)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9- ]{1,50}$/", ObjectSerializer::toString($cardholder_name)))) {
            throw new \InvalidArgumentException("invalid value for \$cardholder_name when calling Card., must conform to the pattern /^[a-zA-Z0-9- ]{1,50}$/.");
        }
     ...
     * Sets expiry_month
     *
     * @param string $expiry_month カード有効期限(月)
     *
     * @return self
     */
    public function setExpiryMonth($expiry_month)
    {
        ...
        if ((!preg_match("/^[0-9]{2}$/", ObjectSerializer::toString($expiry_month)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_month when calling Card., must conform to the pattern /^[0-9]{2}$/.");
        }
     ...
     * Sets expiry_year
     *
     * @param string $expiry_year カード有効期限(年)
     *
     * @return self
     */
    public function setExpiryYear($expiry_year)
    {
        ...
        if ((!preg_match("/^[0-9]{4}$/", ObjectSerializer::toString($expiry_year)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_year when calling Card., must conform to the pattern /^[0-9]{4}$/.");
        }
     ...
     * Sets security_code
     *
     * @param string|null $security_code セキュリティコード<br>CVCやCVVとも呼ばれます。
     *
     * @return self
     */
    public function setSecurityCode($security_code)
    {
        ...
        if ((!preg_match("/^[0-9]{3,4}$/", ObjectSerializer::toString($security_code)))) {
