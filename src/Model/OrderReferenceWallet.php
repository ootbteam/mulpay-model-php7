...
/**
 * OrderReferenceWallet Class Doc Comment
 *
 * @category Class
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 ...
 */
class OrderReferenceWallet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderReferenceWallet';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OotbTeam\MulPay\Model\StatusWallet',
        'charge_type' => 'string'
    ];
    ...
    public const CHARGE_TYPE_WALLET = 'WALLET';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling OrderReferenceWallet., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
    ...
    public function setAccessPass($access_pass)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_pass)))) {
            throw new \InvalidArgumentException("invalid value for \$access_pass when calling OrderReferenceWallet., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     * Gets status
     *
     * @return \OotbTeam\MulPay\Model\StatusWallet|null
     */
     ...
     * Sets status
     *
     * @param \OotbTeam\MulPay\Model\StatusWallet|null $status status
     *
     * @return self
     */
     ...
     * Sets charge_type
     *
     * @param string|null $charge_type 支払いタイプ   - `WALLET`: Pay払い
     *
     * @return self
     */
