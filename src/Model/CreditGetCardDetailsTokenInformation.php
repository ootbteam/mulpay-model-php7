...
/**
 * CreditGetCardDetailsTokenInformation Class Doc Comment
 *
 * @category Class
 * @description クレカ払い カードの詳細情報返却(/credit/getCardDetails)のリクエストパラメーター(トークン版)
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditGetCardDetailsTokenInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditGetCardDetailsTokenInformation';
