...
/**
 * AmazonPayCancelWebhookRequest Class Doc Comment
 *
 * @category Class
 * @description Amazon Pay V2のキャンセル結果通知リクエストパラメーター
 * @package  OotbTeam\MulPay
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AmazonPayCancelWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AmazonPayCancelWebhookRequest';
    ...
    public const EVENT_SUCCEEDED = 'REFUND_SUCCEEDED';
    public const EVENT_FAILED = 'REFUND_FAILED';
    ...
    */
    ...
    public function setAccessId($access_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9]{32}$/", ObjectSerializer::toString($access_id)))) {
            throw new \InvalidArgumentException("invalid value for \$access_id when calling AmazonPayCancelWebhookRequest., must conform to the pattern /^[a-zA-Z0-9]{32}$/.");
        }
     ...
     * Sets event
     *
     * @param string $event Webhookイベントタイプ   - `REFUND_SUCCEEDED`：キャンセル成功 - `REFUND_FAILED`：キャンセル失敗
     *
     * @return self
     */
